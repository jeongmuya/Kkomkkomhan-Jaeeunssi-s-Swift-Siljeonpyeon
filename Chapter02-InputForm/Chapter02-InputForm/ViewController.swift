...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblEmail.frame = CGRect(x: 27, y: 150, width: 100, height: 30)
        lblEmail.text = "이메일"
...
//        lblEmail.font = UIFont.systemFont(ofSize: 14)
        ...
        lblUpdate.frame = CGRect(x: lblEmail.frame.origin.x, y: 200, width: 100, height: 30)
        lblUpdate.text = "자동갱신"
//        lblUpdate.font = UIFont.systemFont(ofSize: 14)
        ...
        lblInterval.frame = CGRect(x: lblEmail.frame.origin.x, y: 250, width: 100, height: 30)
...
//        lblInterval.font = UIFont.systemFont(ofSize: 14)
        ...
        self.paramEmail.frame = CGRect(x: 120, y: 150, width: 220, height: 30)
        self.paramEmail.font = UIFont.systemFont(ofSize: 13)
        self.paramEmail.borderStyle = UITextField.BorderStyle.roundedRect
        self.paramEmail.autocapitalizationType = .none // <- 대소문자 자동 변환 가능을 해제하는 문구
        ...
        self.paramInterval.frame = CGRect(x: 120, y: 250, width: 50, height: 30)
        self.paramInterval.minimumValue = 1 // 1. 스테퍼가 가질 수 있는 최소값
        self.paramInterval.maximumValue = 100 // 2. 스테퍼가 가질 수 있는 최대값
        self.paramInterval.stepValue = 1 // 3. 스테퍼의 값 변경 단위
        self.paramInterval.value = 1 // 4. 초기값 설정
        ...
        self.txtInterval.frame = CGRect(x: 250, y: 250, width: 100, height: 30)
        self.txtInterval.font = UIFont.systemFont(ofSize: 12)
        self.txtInterval.textColor = UIColor.red
        self.txtInterval.text = "1분마다"
